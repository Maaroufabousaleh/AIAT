...
Commits `080ee18` and `f6baebc` add the bounded `aiat_gateway` model-worker edge:
...
provider-backed dispatch and hardened sandbox evidence remain open.
