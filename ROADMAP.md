...
| Area | Current state |
| --- | --- |
| Integration baseline | Reviewed implementation work is present at implementation baseline `90ac61ffa1858ae6279a9dd4143c550cb00729d8`; the canonical OSS audit remains frozen to its separate audited SHA, and the reviewed OpenHands tip is `15d2c1a874a2748548338066782b89561353de2e`. |
