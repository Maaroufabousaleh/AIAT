...
retaining only scalar status, usage, and error metadata. No live invocation was
run for this update; durable Postgres, independent-host, sandbox, recovery,
