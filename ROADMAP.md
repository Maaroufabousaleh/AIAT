...
The latest grouped verification (`ac24b5c`, based on the workflow-control
...
docs, and the existing network/sandbox evidence; current ledger snapshot
`a6fcbaa`, 2026-08-18) keeps the static release ledger at 51/51 pass and the
