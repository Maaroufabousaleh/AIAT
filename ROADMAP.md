...
The latest grouped verification through `c186457` (including the bounded
...
`351444a`/`f385bd7`/`3833631`, and the refreshed release ledger `c186457`; based
...
the existing network/sandbox evidence; current ledger snapshot `c186457`,
2026-08-18) keeps
...
| Bounded object-store provider-pair recovery | [Data, Storage, Memory, and Retention](Docs/current/FEATURE_DATA_STORAGE_AND_MEMORY.md), [Object-Store Migration Review Status](Docs/current/FEATURE_OBJECT_STORE_MIGRATION_STATUS.md), [P2 scale plan](Docs/current/plans/P2_SCALE_STORAGE_AND_AUTONOMY_PLAN.md), [`check_object_store_provider_pair.py`](mas/scripts/check_object_store_provider_pair.py), [`test_check_object_store_provider_pair.py`](mas/scripts/tests/test_check_object_store_provider_pair.py), [live evidence](mas/docs/provenance/object_store_provider_pair_evidence.json); commits `351444a`/`f385bd7`/`3833631` certify three-object checksum dual-write between two local MinIO endpoints, adapter-boundary primary-loss rejection, secondary-only clean recovery, payload-free output, and zero cleanup. Provider-diverse durability, actual provider outage, KMS, clean-host, and disaster-recovery evidence remain open |
