...
The latest grouped verification (`8ae3125`, based on the workflow-control
...
docs, the encrypted backup envelope/evidence certificate, and the existing
network/sandbox evidence; current ledger snapshot `0f53826`, 2026-08-18) keeps
