...
The latest grouped verification (`6cf39b6`, based on the workflow-control
fixture extension, the durable local Postgres flow-instance recovery
...
the existing network/sandbox evidence; current ledger snapshot `268c8f3`,
2026-08-18) keeps
