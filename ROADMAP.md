...
recovery evidence through migration `0039_worker_host_fencing`; live worker
dispatch, host-pool separation, provider-backed recovery, and Firecracker
remain open.
