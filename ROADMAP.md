...
The latest grouped verification (`2ad5d4c`, based on the workflow-control
fixture extension, the durable local Postgres flow-instance recovery
certificate, the maintained feature/plan/status docs, and the existing
network/sandbox evidence; current ledger snapshot `d6cf357`, 2026-08-18) keeps
the static release ledger
at 51/51 pass and confirms the protocol, documentation-index, provenance,
...
scoped cleanup; native/live worker, provider, audit, watchdog, UI, and
cold-crash recovery remain separate gates.
