...
The latest bounded dashboard increment is the System Overview source-status
...
partial fixture runs pass 1/1 (`50cee61`). Retained stale history and live
control-plane evidence remain open.
