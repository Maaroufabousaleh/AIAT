...
retained. Live provider configuration/callback, selected model-backed worker
read-back, complete mail-span/SLO evidence, and API/dashboard incident deep
links remain open.
...
- [x] payload-free `aiat.trace-incident.v1` summary and deterministic/
  ...
  coverage are descriptive, while API/dashboard deep links and live incident
  population remain separate evidence work;
