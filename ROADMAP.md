...
The latest grouped verification (`b8a0c73`, 2026-08-18) keeps the static
release ledger at 48/48 pass and confirms the protocol, documentation-index,
provenance, and host-restart-boundary checks. This does not advance R1 to
release-ready: the native host, live provider/worker/sandbox, pending security
review, and clean-worktree gates remain open. The durable selected-model host
certificate was then tightened by `8ed53df` to execute the production
