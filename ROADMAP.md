...
The latest grouped verification (`3e81606`, based on the workflow-control
...
complete local governed run-version pin certificate, the maintained
feature/plan/status docs, and the existing network/sandbox evidence; current
ledger snapshot `cf97beb`, 2026-08-18) keeps the static release ledger at
51/51 pass and confirms the protocol, documentation-index, provenance,
...
version read-back; independent deployed-host/process, provider, sandbox, and
live dispatch coverage remain separate gates.
