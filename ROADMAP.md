...
`85369fe`/`cfafe38`; live provider ingress, selected model-backed worker
read-back, and complete mail-span/SLO evidence remain open.
...
- [x] identity-service migration `0003_mail_edge_observations`, signed
  ...
  (`cfafe38`); provider ingress verification and selected-worker live evidence
  remain separate;
