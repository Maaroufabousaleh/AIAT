...
5. [x] Add the fail-closed local image identity probe (`7d69fbd`) and development/release wrapper separation (`fd41874`); resolve deployment image refs and generate matching source/version provenance/SBOM remain release work.
