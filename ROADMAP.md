...
The latest grouped verification (`b66421a`, based on the network-policy
contract, refreshed local matrix, and current-ledger snapshot, 2026-08-18) keeps the static release ledger
