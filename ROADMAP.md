...
The latest grouped verification (`02c59fe`, based on the workflow-control
fixture extension, the maintained feature/plan/status docs, and the existing
network/sandbox evidence; current ledger snapshot `578f54d`, 2026-08-18) keeps
...
transition history and cold recovery remain open.
