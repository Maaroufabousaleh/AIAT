...
The latest grouped verification (`cbfa2cc`, based on the network-policy,
OpenCode sandbox contract, refreshed local matrix, and current-ledger snapshot,
2026-08-18) keeps the static release ledger
