...
- [x] Export and reconcile the deterministic `aiat.model-profile-catalogue.v1` runtime/profile catalogue with versioned provider/model/capability/price/privacy/region data; local live evidence now observes complete 93 approved covered versions out of 93 persisted versions with no findings after exact unreferenced smoke-fixture cleanup.
