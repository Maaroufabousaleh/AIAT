...
- Add stale/offline/partial/denied/conflict/rollback designs. System
  ...
  governance read surface, and System Control now expose explicit
  stale/partial/conflict endpoint failures and retryable first-load/offline states;
...
- Deep-link statuses to evidence, traces, decisions, and recovery; the CEO
  ...
  safe detail across a failed refresh; governance and System Control read-state
  recovery are also covered by focused 1/1 source-built tests; broader
