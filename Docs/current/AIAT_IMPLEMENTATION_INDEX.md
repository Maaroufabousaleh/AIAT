...
**Refresh baseline:** `23838249a1b15d3a3cd9fb028d1ca1ef55cb5ceb`
...
| --- | --- | --- |
| Source revision at refresh | **`23838249a1b15d3a3cd9fb028d1ca1ef55cb5ceb`** | The refresh baseline is the implementation commit immediately before this documentation refresh; the checks below describe that code baseline and do not close live/operator gates. |
