...
- Mail-edge observation contracts/checker (`85369fe`) pass the deterministic
  payload-free delivery/webhook/bounce fixture; provider signature
  verification, identity-service persistence, selected worker live read-back,
  and complete mail-span evidence remain open and non-gating.
