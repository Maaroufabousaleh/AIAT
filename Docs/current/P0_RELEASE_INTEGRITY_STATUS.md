...
- The project-detail page now also has explicit first-load unavailable/retry recovery (`f364763`, source-built `project-detail-states.spec.ts` 1/1); full project-page composition and live provider/worker evidence remain separate.
