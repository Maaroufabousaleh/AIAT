...
The maintained dashboard evidence now also includes Flows list stale/retry recovery (`a0faf5b`, source-built `flows-states.spec.ts` 1/1); native/live flow evidence remains separate from this preparatory P1 result.
