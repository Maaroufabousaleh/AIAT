...
`7dc416baf77b0282a010f5741213bd0dddea4395`; the branch now also contains the
docs-only status reconciliation `dabaa44da69a7191fc86817d2e4219c211ba115a`.
...
- The host-safe local Compose sweep (`38a8ab7`, evidence refresh `5f0c611`, observed
  ...
  The six blockers are native release environment/image identity, gVisor,
  Firecracker, outbound mail, and self-improvement source selection; this
  profile does not change `NO-RELEASE`. A transient first aggregate
