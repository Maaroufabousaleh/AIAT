...
- The bounded trace incident projection/checker (`c357fdf`) is covered by
  deterministic core/script tests and remains a read-only descriptive summary;
  it does not turn partial coverage, incident findings, or licence metadata
