...
The secret-safe operational diagnostics group (`2860838`) is implemented and
covered by focused API/contract tests; its route is read-only and does not
turn dependency or licence metadata into a release gate.
