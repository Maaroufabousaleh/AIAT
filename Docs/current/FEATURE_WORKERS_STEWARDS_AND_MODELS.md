...
- `GatewayWorkerAdapter` and `adapter_for_transport("aiat_gateway")` now
  ...
  reconciliation checker. External provider dispatch, durable host execution,
  and hardened sandbox certification remain separate gates.
