...
- Evidence-package core review batch: commit `a44a1aa`; [`test_evidence_package_runner.py`](../../mas/packages/mas-core/tests/test_evidence_package_runner.py) and [`check_project_evidence_package.py`](../../mas/scripts/check_project_evidence_package.py) cover deterministic grouping, metadata-only notices, and fail-closed live mode.
