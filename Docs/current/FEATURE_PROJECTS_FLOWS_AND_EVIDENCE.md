...
- Project evidence package page stale/retry recovery: [`page.tsx`](<../../mas/apps/mas-dashboard/app/(dashboard)/projects/[id]/evidence/page.tsx>) and [`project-evidence-states.spec.ts`](../../mas/apps/mas-dashboard/e2e/project-evidence-states.spec.ts) (commit `bc80ad5`, source-built 1/1). A successful package remains visible through a failed refresh, the warning identifies last-known data, Retry recovers the package, and the initial error path remains explicit.
