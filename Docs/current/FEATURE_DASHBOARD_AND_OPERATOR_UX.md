...
- Improve stale/conflict/rollback and partial-evidence experiences; system
  ...
  dead-letter queue now have explicit stale/partial/conflict and
  first-load/offline retry states, while broader page-specific denial and
