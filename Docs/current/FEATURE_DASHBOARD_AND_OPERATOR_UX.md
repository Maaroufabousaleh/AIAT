...
- Improve stale/conflict/rollback and partial-evidence experiences; system
  ...
  combined governance read surface now have explicit stale/partial/conflict and
  first-load/offline retry states, while broader page-specific denial and rollback
  coverage remains.
