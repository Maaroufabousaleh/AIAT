...
- Improve stale/conflict/rollback and partial-evidence experiences; system
  ...
  stale/partial/conflict states; the Flows list now has explicit stale/retry
  and first-load/offline retry states, while broader page-specific denial and
