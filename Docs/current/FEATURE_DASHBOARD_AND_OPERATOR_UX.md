...
- [x] Add bounded CEO citation/deep-link coverage across tools, models, workers,
  ...
  scalar-only trace summaries, and operator-authenticated artifact/usage reads;
  broader stale/offline states and full golden-path coverage remain.
