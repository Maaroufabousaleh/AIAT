...
- The operator-only `GET /observability/retention/plan` route and
  ...
  Production retention enforcement, authoritative legal holds, erasure, project
  narrowing, audit, and restore parity remain separate storage/recovery gates.
  The local Postgres execution certificate (`96f5fc0`) is retained at
