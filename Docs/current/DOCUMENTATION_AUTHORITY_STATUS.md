...
The mail-edge observation groups `85369fe`, `cfafe38`, and `2d21a2f` add the maintained
...
callback certification, selected worker live read-back, and complete mail-span
