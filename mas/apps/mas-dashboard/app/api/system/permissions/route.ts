...
const POLICY_RULES = {
  ...
  admin: {
    ...
    devops_pm_extra_tools: ["infra.*", "cicd.*", "monitoring.*", "secrets.*"],
  },
  worker: {
...
function buildCommunicationMatrix() {
  ...
  const targets = ["exec_ceo", "exec_coo", "office_cfo", "office_cio", "office_chrm", "office_cso", "office_cto", "dept_production", "dept_system", "dept_qa", "dept_devops"];
  ...
  const rolePermissions: Record<string, Record<string, string[]>> = {
    ...
    executive: {
      ...
      "dept_production": ["TASK", "ADMIN_TASK", "SPRINT_PLAN", "DIRECTIVE"],
      "dept_system": ["TASK", "ADMIN_TASK", "SPRINT_PLAN", "DIRECTIVE"],
      "dept_qa": ["TASK", "ADMIN_TASK", "SPRINT_PLAN", "DIRECTIVE"],
      "dept_devops": ["TASK", "ADMIN_TASK", "SPRINT_PLAN", "DIRECTIVE"],
    },
    c_suite: {
      ...
      "dept_production": ["SPRINT_PLAN", "DIRECTIVE", "ADMIN_REPLY"],
      "dept_system": ["SPRINT_PLAN", "DIRECTIVE", "ADMIN_REPLY"],
      "dept_qa": ["SPRINT_PLAN", "DIRECTIVE", "ADMIN_REPLY"],
      "dept_devops": ["SPRINT_PLAN", "INFRA_READY", "DIRECTIVE", "ADMIN_REPLY"],
    },
    admin: {
      ...
      "dept_production": ["TASK", "RESULT", "QUERY", "RESPONSE", "ISSUE_COMPLETE"],
      "dept_system": ["TASK", "RESULT", "QUERY", "RESPONSE", "ISSUE_COMPLETE"],
      "dept_qa": ["TASK", "RESULT", "QUERY", "RESPONSE", "ISSUE_COMPLETE"],
      "dept_devops": ["TASK", "RESULT", "QUERY", "RESPONSE", "ISSUE_COMPLETE"],
    },
    worker: {
      "dept_production": ["TASK", "RESULT", "QUERY", "RESPONSE", "ISSUE_COMPLETE", "ESCALATION", "ADMIN_REPLY"],
      "dept_system": ["TASK", "RESULT", "QUERY", "RESPONSE", "ISSUE_COMPLETE", "ESCALATION", "ADMIN_REPLY"],
      "dept_qa": ["TASK", "RESULT", "QUERY", "RESPONSE", "ISSUE_COMPLETE", "ESCALATION", "ADMIN_REPLY"],
      "dept_devops": ["TASK", "RESULT", "QUERY", "RESPONSE", "ISSUE_COMPLETE", "ESCALATION", "ADMIN_REPLY"],
    },
    sub_agent: {
      "dept_production": ["RESULT", "QUERY"],
      "dept_system": ["RESULT", "QUERY"],
      "dept_qa": ["RESULT", "QUERY"],
      "dept_devops": ["RESULT", "QUERY"],
    },
  };
