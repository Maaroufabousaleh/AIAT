...
const WORKFLOW_STATES = [
  ...
  { id: "INFRA_PROVISIONING", label: "Infra Provisioning", description: "DevOps provisioning infrastructure" },
...
const ORCHESTRATION_FLOWS = [
  {
    ...
    nodes: [
      ...
      { id: "n8", type: "task", label: "Infra Provisioning", state: "INFRA_PROVISIONING", team: "dept_devops" },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "e3", type: "task", label: "Handle Worker Escalation", team: "dept_*" },
