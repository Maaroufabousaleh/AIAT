"""Compatibility import for the canonical CrewAI adapter.
...
from .runtime_adapters import CrewAIAdapter, CrewAICapabilities

__all__ = ["CrewAIAdapter", "CrewAICapabilities"]
