...
legacy run-correlated fallback, PM inbound metadata, and the durable
  ...
  payloads or new gates. Selected-worker live evidence, configured provider
  callbacks, live retention enforcement, complete mail-span coverage, and
  richer live incident chronology are still P2 work. The local
