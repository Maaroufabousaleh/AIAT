...
4. Mobile/accessibility/theme completion and the remaining dashboard stale/offline/conflict states. Identity, PM integration, project-list/detail, system-visualisation, evidence-detail, governance, System Control, Tools catalogue, dead-letter queue, credentials, Metrics, Flows, Container Logs, and Agent Streams read surfaces now have focused stale/retry coverage; native-Linux/page-level visual and broader recovery evidence remain open.
