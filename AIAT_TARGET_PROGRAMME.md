...
legacy run-correlated fallback, PM inbound metadata, and the durable
  ...
  keeping partial coverage descriptive. Selected-worker live evidence,
  configured provider callbacks, live retention enforcement, complete mail-span
  coverage, and API/dashboard incident views are still P2 work. The local
