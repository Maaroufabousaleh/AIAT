...
4. Mobile/accessibility/theme completion and the remaining dashboard stale/offline/conflict states. Identity, PM integration, project-detail, system-visualisation, evidence-detail, governance, and System Control read surfaces now have focused stale/retry coverage; native-Linux/page-level visual and broader recovery evidence remain open.
